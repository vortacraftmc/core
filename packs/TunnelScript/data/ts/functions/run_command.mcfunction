# Run a single command. Input: storage tunnelscript:in { "command": "say hi" }
# ("cmd" and "command" are accepted as aliases too.)
...
execute if entity @s[tag=tunnelscript.trusted] run data modify storage tunnelscript_core:gatework req.action set value "run_command"
execute if entity @s[tag=tunnelscript.trusted] run data modify storage tunnelscript_core:gatework req.label set value "run a single command"
execute if entity @s[tag=tunnelscript.trusted] run data modify storage tunnelscript_core:gatework req.commands set value {}
execute if entity @s[tag=tunnelscript.trusted] run data modify storage tunnelscript_core:gatework req.commands.command set from storage tunnelscript:in command
