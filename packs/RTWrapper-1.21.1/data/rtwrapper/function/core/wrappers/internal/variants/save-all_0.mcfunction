...
# NOTE: /save-all is a dedicated-server-console-only command in vanilla Minecraft
...
tellraw @a[tag=rtwrapper.debug] [{"text":"[RTWrapper] ","color":"red"},{"text":"/save-all cannot run from a datapack function (server-console-only command).","color":"gray"}]
