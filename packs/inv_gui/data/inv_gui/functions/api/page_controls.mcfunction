...
#
# Designed to be called after inv_gui:api/paginate using its out.has_prev
...
#           Whether a previous page exists (from inv_gui:api/paginate out)
#       has_next: boolean (0b / 1b)
#           Whether a next page exists (from inv_gui:api/paginate out)
#
# @output
#   storage inv_gui:data in.contents
#       Appends one 9-slot navigation row
#
# @api

function inv_gui:core/api/page_controls/_
