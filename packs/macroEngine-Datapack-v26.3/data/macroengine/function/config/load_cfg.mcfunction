...
# Key naming: #vortacraftmc.packs.macroengine.config.load.<name>
...
execute unless score #vortacraftmc.packs.macroengine.config.load.timeout_seconds macroengine.meta matches 1.. run scoreboard players set #vortacraftmc.packs.macroengine.config.load.timeout_seconds macroengine.meta 300
...
execute unless score #vortacraftmc.packs.macroengine.config.load.sandbox_enabled macroengine.meta matches 0..1 run scoreboard players set #vortacraftmc.packs.macroengine.config.load.sandbox_enabled macroengine.meta 0
