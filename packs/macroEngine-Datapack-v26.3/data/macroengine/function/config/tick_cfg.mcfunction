...
#
# Key naming: #vortacraftmc.packs.macroengine.config.tick.<name>
...
execute unless score #vortacraftmc.packs.macroengine.config.tick.rate macroengine.meta matches -2147483648..2147483647 run scoreboard players set #vortacraftmc.packs.macroengine.config.tick.rate macroengine.meta 1

# --- tick.pause: 0 = running, 1 = paused (config-level flag, separate from the paused check in core/tick.mcfunction) ---
execute unless score #vortacraftmc.packs.macroengine.config.tick.pause macroengine.meta matches -2147483648..2147483647 run scoreboard players set #vortacraftmc.packs.macroengine.config.tick.pause macroengine.meta 0
