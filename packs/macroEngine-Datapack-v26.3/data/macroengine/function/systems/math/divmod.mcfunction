...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.math_divmod","color":"aqua"},{"text":"($(value)/$(divisor))","color":"gray"},{"translate":"macroengine.arrow","color":"#555555"},{"text":"q=","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"quotient","color":"green"},{"text":" r=","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"remainder","color":"green"}]
