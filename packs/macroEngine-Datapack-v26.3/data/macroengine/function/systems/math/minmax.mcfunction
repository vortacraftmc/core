...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.math_minmax","color":"aqua"},{"text":"($(a),$(b))","color":"gray"},{"translate":"macroengine.arrow","color":"#555555"},{"translate":"macroengine.fmt.min","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"min","color":"green"},{"text":" max=","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"max","color":"green"}]
