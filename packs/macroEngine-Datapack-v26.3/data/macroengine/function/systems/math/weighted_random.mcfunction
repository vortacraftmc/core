...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.math_weighted_random","color":"aqua"},{"translate":"macroengine.fmt.total_roll","color":"gray"},{"score":{"name":"$wr_roll","objective":"macroengine.tmp"},"color":"yellow"},{"translate":"macroengine.arrow","color":"#555555"},{"plain":true ,"storage":"macroengine:output","nbt":"result","color":"green"}]
