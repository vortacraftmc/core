...
data modify storage macroengine:core/internal/string/temp data.CheckString.String set string storage macroengine:core/internal/string/temp data.String 1
data modify storage macroengine:core/internal/string/temp data.CheckString.Find set string storage macroengine:core/internal/string/input replace.Find 1
