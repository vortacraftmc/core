...
data modify storage macroengine:core/internal/string/temp data.CheckString.Find set string storage macroengine:core/internal/string/input find.Find 0 -1
