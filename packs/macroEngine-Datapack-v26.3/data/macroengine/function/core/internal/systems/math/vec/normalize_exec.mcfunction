...
# # tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.math_vec_normalize","color":"aqua"},{"translate":"macroengine.fmt.len","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"length","color":"yellow"},{"translate":"macroengine.arrow","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"x","color":"yellow"},{"text":",","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"y","color":"yellow"},{"text":",","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"z","color":"yellow"}]
