...
# # tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.math_vec_angle_between","color":"aqua"},{"translate":"macroengine.fmt.cos","color":"gray"},{"score":{"name":"$vang_dot","objective":"macroengine.tmp"},"color":"yellow"},{"translate":"macroengine.arrow","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"result","color":"yellow"},{"text":"°","color":"gray"}]
