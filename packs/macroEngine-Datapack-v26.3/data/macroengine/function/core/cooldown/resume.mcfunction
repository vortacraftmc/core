...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.cooldown_resume","color":"aqua"},{"text":"▶ ","color":"green"},{"text":"$(player)","color":"white"},{"text":":","color":"#555555"},{"text":"$(key)","color":"aqua"},{"translate":"macroengine.debug.resumed","color":"#555555"},{"score":{"name":"$cdr_rem","objective":"macroengine.tmp"},"color":"yellow"},{"translate":"macroengine.fmt.t_remaining_paren","color":"#555555"}]
