...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.cooldown_detail","color":"aqua"},{"text":"$(player)","color":"white"},{"translate":"macroengine.arrow","color":"#555555"},{"text":"$(key)","color":"aqua"},{"translate":"macroengine.fmt.active","color":"#555555"},{"plain":true ,"storage":"macroengine:output","nbt":"active","color":"green"},{"translate":"macroengine.fmt.rem","color":"#555555"},{"plain":true ,"storage":"macroengine:output","nbt":"remaining","color":"green"},{"translate":"macroengine.fmt.exp","color":"#555555"},{"plain":true ,"storage":"macroengine:output","nbt":"expires","color":"green"}]
