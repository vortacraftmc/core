...
# # $tellraw @a[tag=macroengine.debug] ["",{"translate":"macroengine.prefix","color":"#00AAAA","bold":true},{"translate":"macroengine.path.lib_ticks_to_time","color":"aqua"},{"text":"($(ticks)t)","color":"gray"},{"translate":"macroengine.arrow","color":"#555555"},{"plain":true ,"storage":"macroengine:output","nbt":"hours","color":"green"},{"text":"h ","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"minutes","color":"green"},{"text":"m ","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"seconds","color":"green"},{"text":"s ","color":"gray"},{"plain":true ,"storage":"macroengine:output","nbt":"ticks","color":"green"},{"text":"t","color":"gray"}]
