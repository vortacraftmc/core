...
# エンティティを削除
execute if entity @e[type=minecraft:interaction, tag=LCD.Entity, limit=1] run tp @e[type=minecraft:interaction, tag=LCD.Entity] ~ -1000 ~
execute if entity @e[type=minecraft:interaction, tag=LCD.Entity, limit=1] run kill @e[type=minecraft:interaction, tag=LCD.Entity]
